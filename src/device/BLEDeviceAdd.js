...
class BLEDeviceAdd extends Component {
  constructor(props) {
    super(props);
	...
	handleToHelp(event){
		 this.props.history.push('/device/lightAddHelp/BLELighting');
		}
...
export default connect(mapStateToProps, mapDispatchToProps)(BLEDeviceAdd);