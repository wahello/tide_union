...
class DoorAddhelp extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <div className="device addLight">
        <BarTitle onBack={this.handleClickBack} title={Lang.device.doorAddhelp.title} />
        <ScrollView>
        <div className="addWrap">
        <p className="desc"></p>
        	<p className="addDesc">{Lang.device.doorAddhelp.addDesc}</p>      	
        	<div className="nextStep backgroud-Door4"></div>
...
export default connect(mapStateToProps, mapDispatchToProps)(DoorAddhelp);