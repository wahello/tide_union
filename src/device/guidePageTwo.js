...
class GuidePageTwo extends Component {
	constructor(props){
		super(props);
 ...
 handleClickBack(event){
  ...
  nextPage(event){
  	this.props.history.push('/device/guidePageThree');
  }
	...
	<div className='way-step1'>
		<BarTitle onBack={this.handleClickBack} title={Lang.home.title}/>
                    <p className='little-title'>Step two</p>
...
export default connect()(createForm()(GuidePageTwo))